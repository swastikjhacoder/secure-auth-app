...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 via-white to-gray-200 dark:from-black dark:via-zinc-900 dark:to-black flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-5xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 mt-16">
          <div className="p-8 rounded-2xl bg-white/80 dark:bg-zinc-900/70 backdrop-blur-md border border-gray-200 dark:border-zinc-800 shadow-xl shadow-gray-300/40 dark:shadow-black/40 transition hover:scale-[1.02] duration-300">
            <h3 className="text-xl font-semibold">Security Layers</h3>
        ...
        <div className="flex justify-center gap-8 mt-16 pt-10 border-t border-gray-200 dark:border-zinc-800">
          <Link
            href="/login"
            className="min-w-[160px] px-10 py-4 rounded-xl font-semibold text-white 
          ...
          <Link
            href="/register"
            className="min-w-[160px] px-10 py-4 rounded-xl font-semibold
